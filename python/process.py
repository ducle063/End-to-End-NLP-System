...
class ReferenceDocumentProcessor:
    def __init__(self, embedding_model_name='all-MiniLM-L6-v2'):
        ...
        self.collection = self.client.get_or_create_collection(name="reference_docs")
    ...
    def parse_document(self, file_path: str) -> Dict:
        ...
        if 'url' not in metadata or 'title' not in metadata:
            raise ValueError(f"Missing metadata in {file_path}")
...
if __name__ == "__main__":
    ...
    processor.process_folder("data\processed\VNU\\vietnamese")